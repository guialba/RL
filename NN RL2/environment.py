...
class NormalMoveEnv():
    def __init__(self, punishment=-100, sigma=(.01, .3), tau=(1., -1.), wolrd_size=10., goals=[([7.5,7.5],[10.,10.])], walls=[([-8.,-1.],[10., 1.])]):
    ...
    def reset(self, *, seed: Optional[int] = None, options: Optional[dict] = None):
        ...
        self.initial_state = np.random.uniform(low=[-5., -9.5], high=[9.5, -2.], size=2)
